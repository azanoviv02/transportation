package com.netcracker.transportation.algorithms.modi;
...
import static com.netcracker.transportation.utils.GeneralUtils.deepCopy;
...
public class ModiMethod implements TransportationProblemSolver {
     ...
     * @return
     */
    public Solution getSolution(TransportationProblem transportationProblem) {

        int[][] costMatrix = transportationProblem.getBenefitMatrix();
        int[] supplyArray = deepCopy(transportationProblem.getSupplyArray());
        int[] demandArray = deepCopy(transportationProblem.getDemandArray());
        ...
        return new Solution(transportationProblem, allocationMatrix);
    }
